...
class config{
  ...
  public static $minkeepalivesneed = 100; // minimum keep alives need every minute, if less the value, then kick client(checking inactivity clients, happens when new user want connect on full server)
