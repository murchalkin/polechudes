...
class config{
  ...
  // Auth
  public static $token = "пароль"; // token auth
  ...
  // Game
  public static $words = "мышонок,табуретка,кошка,игра"; // words generating(dont use spaces)
  ...
  public static $codewin = "Выиграл игрок с ником:"; // code when player is win returning to all clients
